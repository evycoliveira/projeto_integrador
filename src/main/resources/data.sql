...
insert into customer (name) values("Rebecca Cruz");
insert into customer (name) values("Alex George Oliveira");
insert into customer (name) values("Maria Aparecida Pereira de Oliveira");
